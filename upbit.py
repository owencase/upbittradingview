...
# 네이버 메일 로그인 정보
naver_email = "your_email@naver.com"  # 네이버 이메일
...
def get_tradingview_email():
    ...
    # TradingView에서 보낸 이메일만 필터링
    status, messages = mail.search(None, 'FROM', '"noreply@tradingview.com"')
